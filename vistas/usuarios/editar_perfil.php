							...
							<div class="row">
								...
								<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
									<div class="input-group">
										...
										<strong><input class="form-control" placeholder="Nombre y Apellido" name="txtNomyApe" id="txtNomyApe" type="text" value="<?php echo $usuario->nomyape ?>" required autocomplete="on" autofocus tabindex="1"></strong>
									</div>
								</div>
								...
								<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
									<div class="input-group">
										...
										<strong><input class="form-control" placeholder="Dirección" value="<?php echo $usuario->direccion; ?>" name="txtDireccion" id="txtDireccion" type="text" required autocomplete="on" tabindex="2"></strong>
									</div>
								</div>
								...
								<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
									<div class="input-group">
										...
										<strong><input class="form-control" placeholder="Teléfono" value="<?php echo $usuario->telefono; ?>" name="txtTelefono" id="txtTelefono" type="text" autocomplete="on" tabindex="3"></strong>
									</div>
								</div>
								...
								<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
									<div class="input-group">
										...
										<input class="form-control" placeholder="E-mail" value="<?php echo $usuario->email; ?>" name="txtEmail" id="txtEmail" type="email" required autocomplete="on" tabindex="4">
									</div>
								</div>
