	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12">
				...
				<a href="<?php url("colores/crear") ?>" class="btn btn-success"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> </a>
					...
					<form action="<?php url("colores/editarcolor") ?>" method="POST" role="form">
						...
						<div class="panel-body">
							...
							<div class="row">
								...
								<div class="col-lg-1 col-md-3 col-sm-4 col-xs-4 mt-2">
									<label class="leter text-nowrap" for="Status"><span class="Salida text-nowrap" for="salida" id="salida">Paleta de colores</span>
									</label>
									<input style="width: 100%;" class="form-control" type="color" id="color" name="color" value="<?php echo $color->Style ?>">
								</div>
							</div>
