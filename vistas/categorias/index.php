...
?>
<style>
	#vistaCategorias td:nth-child(1) {
		display: none;

	}

	#vistaCategorias th:nth-child(1) {
		display: none;
	}
</style>
<!-- Contenido Principal -->
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				...
				<h2 class="hstyle">GESTION DE CATEGORIAS</h2>
				<a class="btn btn-primary pull-left " href="<?php echo url("admin"); ?>"><i class="fa fa-home" aria-hidden="true" placeholder="Home"> </i></a> 
				<a href="<?php url("categorias/crear") ?>" class="btn btn-success"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> CATEGORIAS</a>
			</div>
		</div>
		<br>
		<div class="row">
...
<script>
	...
	$(document).on("click", ".btnEliminar", function() {
		...
		alertify.confirm('Eliminar Registro', '¿Está seguro de eliminar el registro?',
			function() {
				window.location.href = window.location.href = "categorias/eliminar?id=" + id;
			},
			function() {
