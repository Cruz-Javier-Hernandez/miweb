...
#vistaTalles td:nth-child(1){
  display:none;
  
}
#vistaTalles th:nth-child(1){
  display:none;
}
</style>
<!-- Contenido Principal -->
<div id="page-wrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">                        
				<h3 class="hstyle">GESTION DE TALLAS</h3>
				<a class="btn btn-primary pull-left " href="<?php echo url("admin"); ?>"><i class="fa fa-home" aria-hidden="true" placeholder="Home"> </i></a>
				<a href="<?php url("talles/crear") ?>" class="btn btn-success"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> TALLAS</a>
			</div>			
		</div>	
		<br>		
		<div class="row">														
