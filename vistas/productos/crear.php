...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		<form action="<?php url("productos/crearproducto") ?>" method="POST" role="form" id="formCrearProducto" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="row">
							<div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
								<label>Rubros <strong style="color: red;">*</strong></label>
							...
							<div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
								...
								<select class="form-control Select2" id="txtCategoria" name="txtCategoria" tabindex="5" style="background-color:#337ab7; color:white;">
									<?php
						...
						<div class="row">
							...
							<div class="col-lg-2 col-md-2 col-sm-6 col-xs-6">
								<label for="btnActualizarStock">Actualizar<strong style="color: red;">*</strong></label>
								<br>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" method="POST" autocomplete="off">

								<label>Foto o imagen del producto</label><br>
								<div class="file is-small has-name">
									<label class="file-label">
										<input class="file-input" type="file" name="producto_foto" id="producto_foto" accept=".jpg, .png, .jpeg">
										<span class="file-cta">
			...
			<div class="panel-footer clearfix">
				<a class="btn btn-danger pull-left" href="<?php echo htmlspecialchars($_SERVER['HTTP_REFERER']); ?>" tabindex="15"><i class="fa fa-ban" aria-hidden="true"></i> Cancelar</a>
				<button name="btnSubmit" type="submit" class="btn btn-success pull-right" tabindex="14"><i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar</button>
			</div>
	</div>
	</form>
</div>
		...
		<div class="modal-content">
			...
			<form id="">
				...
				<div class="modal-footer clearfix">
					<button type="button" class="btn btn-danger pull-left" data-dismiss="modal" tabindex="2"><i class="fa fa-ban" aria-hidden="true"></i> Cancelar</button>
					<button id="btnSaveTalleColor" type="button" class="btn btn-success pull-right" tabindex="1"><i class="fa fa-floppy-o" aria-hidden="true"></i> Actualizar</button>
				</div>
			</form>
		</div>
	</div>
