...
<div id="page-wrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">                        
				<h3 class="hstyle">GESTION DE COMPRAS</h3>
				<a href="<?php url("compras/crear") ?>" id="btnNuevaCompra" class="btn btn-info"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> COMPRAS</a>
			</div>
		</div>	
		<hr>
		<div class="row">
