...
<div id="page-wrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">                        
				<h2 class="hstyle">GESTION DE CLIENTES</h2>
				<a class="btn btn-info pull-left " href="<?php echo url("admin"); ?>"><i class="fa fa-home" aria-hidden="true" placeholder="Home"> </i></a> 
				<a href="<?php url("clientes/crear") ?>" class="btn btn-sucess"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> CLIENTE</a>
			</div>
		</div>	
		<hr>
		<div class="row">
