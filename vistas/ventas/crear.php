	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12">
				...
				<a class="btn btn-danger pull-left " href="<?php url("ventas/"); ?>"><i class="fa fa-reply" aria-hidden="true"></i></a>
			</div>
		</div>
		<div class="row">
				...
				<div class="panel panel-green">
					...
					<div class="panel-body" style="height: 200px;">
						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-4 col-sm-12 ">
								<div class="input-group">
									...
									<input name="txtSucursala" id="txtSucursal" value="<?php echo $producto->idMarca; ?>" type="hidden">
								</div>
							</div>
							<?php
							//if (empty(end($ventas))){
						...
						<div class="row">
							...
							<div class="col-lg-7 form-group" style="display: none;">
		...
		<div class="modal-content">
			...
			<form id="formAltaClientes">
				...
				<div class="modal-footer clearfix">
					<button type="button" class="btn btn-danger pull-left" data-dismiss="modal" tabindex="8"><i class="fa fa-ban" aria-hidden="true"></i> Cancelar</button>
					<button id="btnGuardarCliente" type="submit" class="btn btn-success pull-right" tabindex="7"><i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar</button>
				</div>
			</form>
		</div>
	</div>
						...
						<div class="col-lg-12 form-group">
							...
							<div class="row">
								<div class="col-lg-5 form-group">
									...
									<div class="input-group">
										<input type="number" class="form-control text-right" name="descGral" id="descGral" min="0" value="">
			...
			<div class="panel-body">
				...
				<div class="row">
					...
					<div class="col-lg-5 col-md-4 col-sm-8 col-xs-8">
						<div class="input-group">
							<span class="input-group-addon" id="sizing-addon2">Vendido Por:</span>
							<!-- <label for="Empleado">Venta Por</label> -->
							<select class="form-control" id="Empleado" name="Empleado" tabindex="7">
								<?php
...
<form action="<?php url("ventas/crearventa") ?>" method="POST" role="form" style="display:none">
	...
	<input id="txtSucursalOk" name="txtSucursalOk">
	...
	<input id="txtArrayVentaxProd" name="txtArrayVentaxProd" />
...
<script>
	...
	$('#tabla_productos').DataTable({
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "../libreria/ServerSide/serversideVentasRealizadas.php",
		"columnDefs": [{
			"targets": -1,
			"data": null,
