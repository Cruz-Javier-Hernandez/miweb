...
<div id="page-wrapper">
 ...
 <!--            <div class="col-xs-5 col-xs-offset-2 text-right">
              ...
              <table class="table table-bordered table-condensed text-right">
                <thead>
                  <tr>
                    ...
                    <th>
                      <h5><strong>Precio Unit.(<?php echo $detalleimpositivoventa->moneda; ?>)</strong></h5>
                    </th>
                    <th>
                      <h5><strong>Precio Tot.(<?php echo $detalleimpositivoventa->moneda; ?>)</strong></h5>
                    </th>
                    <th>
                      <h5><strong>Vendido Por</strong></h5>
                    </th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  // el sprintf en este caso que se presenta nos ayuda a redondiar los decimales a %0.2f que son dos dijitos
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php echo $detalleventa->Venta_Por; ?></td>
                    </tr>
                  <?php
                  }
                  ?>
          ...
          <div class="row text-right">
            ...
            <div class="col-xs-2">
              <strong>
                <?php echo $detalleimpositivoventa->moneda;
                echo sprintf('%0.2f', $venta->subTotalNeto); ?><br>
                ...
                echo $detalleimpositivoventa->moneda;
                echo sprintf("%0.2f", $totalConImpuesto);
                ?><br>
              </strong>
            </div>
          </div>
