...
#vistaVentas td:nth-child(1){
  display:none;
  
}
#vistaVentas th:nth-child(1){
  display:none;
}
</style>
<!-- Contenido Principal -->
<div id="page-wrapper">
	<div class="container-fluid">
    	<div class="row">
        	<div class="col-lg-12">                        
                <h3 class="hstyle">GESTION DE VENTAS</h3>	
				<a class="btn btn-primary pull-left " href="<?php echo url("admin"); ?>"><i class="fa fa-home" aria-hidden="true" placeholder="Home"> </i></a>
                <a href="<?php url("ventas/crear") ?>" id="btnNuevaVenta" class="btn btn-success"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> VENTA</a>
			</div>
		</div>
        <br>
		<div class="row">
