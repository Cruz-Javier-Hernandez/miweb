...
?>
<style>
	#vistaGeneros td:nth-child(1) {
		display: none;

	}

	#vistaGeneros th:nth-child(1) {
		display: none;
	}
</style>
<!-- Contenido Principal -->
<div id="page-wrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="hstyle">GESTION DE GENEROS</h2>
				<a class="btn btn-primary pull-left " href="<?php echo url("admin"); ?>"><i class="fa fa-home" aria-hidden="true" placeholder="Home"> </i></a>
				<a href="<?php url("generos/crear") ?>" class="btn btn-success"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> GENERO</a>
			</div>
		</div>
		<br>
		<div class="row">
...
<script>
	...
	$(document).on("click", ".btnEliminar", function() {
		...
		alertify.confirm('Eliminar Registro', '¿Está seguro de eliminar el registro?',
			function() {
				window.location.href = window.location.href = "generos/eliminar?id=" + id;
			},
			function() {
