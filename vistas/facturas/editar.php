	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12">
				...
				<a class="btn btn-info pull-left " href="<?php echo url("facturas"); ?>"><i class="fa fa-list" aria-hidden="true" placeholder="lista"> </i></a>
				...
				<a class="btn btn-success pull-left " href="<?php url("facturas/crear"); ?>"><i class="fa fa-plus" aria-hidden="true"></i></a>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-12">
							...
							<div class="row">
								...
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
									...
									<div class="input-group">
										...
										<select name="txtIdprovedor" id="txtIdprovedor" class="form-control" tabindex="1" autofocus>
											...
											?>
												<option value="<?php echo $proveedor->id; ?>" <?php echo ($facturas->id_proveedor == $proveedor->id) ? 'selected' : ''; ?>>
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
									...
									<div class="input-group">
										...
										<select disabled name="txtIdSucursal" id="txtIdSucursal" class="form-control" tabindex="2">
											<?php
