	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				...
				<a href="<?php url("facturas/crear") ?>" id="btnNuevaVenta" class="btn btn-success"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> FACTURAS</a>
			</div>
		</div>
		<br>
		<div class="row">
...
<script>
	...
	$(document).on("click", ".btnEliminar", function(){		
		...
		function(){window.location.href=window.location.href="facturas/eliminar?id="+id;},
