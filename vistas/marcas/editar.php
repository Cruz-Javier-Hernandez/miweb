	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<a class="btn btn-primary pull-left " href="<?php echo url("admin"); ?>"><i class="fa fa-home" aria-hidden="true" placeholder="Home"> </i></a>
				<a class="btn btn-info pull-left " href="<?php echo url("marcas"); ?>"><i class="fa fa-list" aria-hidden="true" placeholder="lista"> </i></a>
				...
				<a class="btn btn-success pull-left " href="<?php url("marcas/crear"); ?>"><i class="fa fa-plus" aria-hidden="true"></i></a>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-12">
