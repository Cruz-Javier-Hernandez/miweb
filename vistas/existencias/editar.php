	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12">
				...
				<a class="btn btn-info pull-left " href="<?php echo url("existencias"); ?>"><i class="fa fa-list" aria-hidden="true" placeholder="lista"> </i></a>
				...
				<div class="panel panel-azulTienda">
					...
					<form action="<?php url("existencias/editarexistencia") ?>" method="POST" role="form">
						...
						<div class="panel-footer clearfix">
							...
							<button type="submit" class="btn btn-success pull-right" tabindex="3"><i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar</button>
						</div>
					</form>
				</div>
			</div>
