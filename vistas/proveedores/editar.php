	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12">
				...
				<a class="btn btn-info pull-left " href="<?php echo url("proveedores"); ?>"><i class="fa fa-list" aria-hidden="true" placeholder="lista"> </i></a>
				...
				<a class="btn btn-success pull-left " href="<?php url("proveedores/crear"); ?>"><i class="fa fa-plus" aria-hidden="true"></i></a>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-12">
					...
					<form action="<?php url("proveedores/editarproveedor") ?>" method="POST" role="form">
						...
						<div class="panel-body">
							...
							<div class="form-group">
								<label for="">Nombre de Provedor</label>
						...
						<input value="<?php echo $proveedor->condTributaria ?>" name="txtCondTributaria" type="text" class="form-control" id="txtCondTributaria" placeholder="Condición Tributaria" style="text-transform:uppercase" tabindex="6">-->
								...
								<select name="txtCondTributaria" id="txtCondTributaria" class="form-control" tabindex="6">
									...
									<option value="CFS" <?php if ($proveedor->condTributaria == "CFS") echo ' selected="selected"'; ?>>CREDITO FISCAL</option>
...
<script>
	$('form').submit(function() {
		...
		if (var_razsoc == "" || var_telefono == "" || var_condTributaria == "") {
