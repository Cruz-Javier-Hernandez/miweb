...
<div id="page-wrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">                        
				<h2 class="hstyle">GESTION DE TARJETAS</h2>
				<a href="<?php url("tarjetas/crear") ?>" class="btn btn-info"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> TARJETAS</a>
			</div>
		</div>	
		<hr>
		<div class="row">
