    ...
    <div id="wrapper"><!-- Inicio "wrapper" -->
        ...
        <nav class="navbar navbar-default " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <div class="row">
                    <a class="navbar-brand" href='<?php url("admin") ?>'><img style="padding-left: 10px;" src="<?php asset("img/LogoMenuSup.png") ?>">
                     <?= $_SESSION["Empresa"]?>
                    </a>
                </div>
            ...
            <div class="collapse navbar-collapse sidebar" role="navigation" style="padding: 0px;">
                <div class="sidebar-nav ">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-folder-open"></i> Catalogos<span class="fa arrow"></span></a>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-folder-open"></i> Facturas<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li>
                                <a href='<?php url("facturas") ?>'><i class="fa fa-file-text-o" aria-hidden="true"></i>
                                    Gestor de Facturas</a>
                            </li>
                            <li>
                                <a href='<?php url("calendario/factura") ?>'><i class="fa fa-calendar" aria-hidden="true"></i> Calendario</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse">
                            <li>
                                <a href='<?php url("empleados") ?>'><i class="fa fa-file-text-o" aria-hidden="true"></i>
                    ...
                    <li>
                        <a href=<?php url("calendario/index") ?>><i class="fa fa-calendar"></i> Calendario</span></a>
                        <!-- /.nav-second-level -->
                    </li>
                    </ul>
