...
<title><?= $_SESSION["Empresa"]?></title>
    ...
    <!-- include styli for container select-->
    ...
    <script src="<?php echo asset("bower_components/js/codigo_base.js"). '?v=' . time();  ?>"></script>
    <!--Direccio0n de JS para funcion de Select -->
            ...
            <div class="collapse navbar-collapse sidebar" role="navigation">
                <div class="sidebar-nav ">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse">
                            <li>
                                <a href='<?php url("facturas") ?>'>Gestor de Facturas</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
