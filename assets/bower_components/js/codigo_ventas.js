$(document).ready(function(){    
	...
	$(".btnMostrarTallesColores").click(function () {
		...
		idCod = 			$(this).data('id'); //capturo el ID			
   ...
   $("#btnAgregarCarritoVentas").click(function(){				
		$("#tablaTalleColor tr td .tdCantidad").each(function(){															
			if($(this).val() > 0){				
				...
				v_desc = parseFloat($("#txtDescuentoVenta").val()).toFixed(2) / 1;
			
				empleadoSeleccionado = $('#Empleado').find('option:selected').text(); // Obtiene el valor seleccionado
			
				v_precioConDesc = (v_desc);
				...
				if($.inArray(v_codigoTalleColor,codigosArray) != -1) {    
					...
					$('#tablaVentas > tbody:last-child').append('<tr><td style="display:none">'+v_idE+'</td><td style="display:none">'+idCod+'</td><td>'+v_codigo+'</td><td style="display:none">'+v_nombre+'</td><td>'+v_talle+'</td><td>'+v_color+'</td><td>'+v_cantidad+'</td><td>'+v_precioVenta+'</td><td>'+v_desc.toFixed(2)+'</td><td style="display:none">'+impuesto_PrecioVenta.toFixed(2)+'</td><td style="display:none">'+precioVentaNeto.toFixed(2)+'</td><td><strong>'+v_subTotal.toFixed(2)+'</strong></td><td><strong>'+empleadoSeleccionado+'</strong></td><td><button class="removerCarritoVentas btn btn-danger btn-sm"><span class="fa fa-times"></span></button></td></tr>');					
...
$('#tablaTalleColor').on('click', 'td', function() {
   ...
   $(this).prop('disabled', true);	
    ...
    $("#btnRegistrarVenta").click(function(){
       ...
       var vendidoporArray 		= []; 	//Array con los vendido por
       ...
       $("#tablaVentas tbody tr").each(function(){		   		   
		   ...
		   vendidoporArray.push($(this).find("td:eq(12)").text());
        ...
        if(v_totVtaConDesc.toFixed(2) == 0){
            ...
            alertify.confirm(
              ...
              function(){
                ...
                $('#txtArrayVentaxProd').val(JSON.stringify(vendidoporArray));
